...
Link to CryoSCOPE SmartMet server collections: https://sm.cryo-scope.eu/edr/collections.

Official SmartMet server EDR API documentation: https://github.com/fmidev/smartmet-plugin-edr/blob/master/docs/Using-EDR-Plugin.md 
